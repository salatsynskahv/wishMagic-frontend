...
function AdminPage() {
  ...
  const handleGetUsers = async () => {
    try {
      ...
      const response = await serviceApi.getUsers(user)
  ...
  const handleDeleteUser = async (username) => {
    try {
      await serviceApi.deleteUser(user, username)
  ...
  const handleSearchUser = async () => {
    try {
      const response = await serviceApi.getUsers(user, userUsernameSearch)
  ...
  const handleGetMovies = async () => {
    try {
      ...
      const response = await serviceApi.getMovies(user)
  ...
  const handleDeleteMovie = async (imdb) => {
    try {
      await serviceApi.deleteMovie(user, imdb)
  ...
  const handleAddMovie = async () => {
    ...
    try {
      await serviceApi.addMovie(user, movie)
      clearMovieForm()
      await handleGetMovies()
    } catch (error) {
      handleLogError(error)
  ...
  const handleSearchMovie = async () => {
    try {
      const response = await serviceApi.getMovies(user, movieTextSearch)
